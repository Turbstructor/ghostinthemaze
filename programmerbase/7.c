...
//ThesnowglowswhiteonthemountaintonightNotafootprinttobeseenAkingdomofisolationAnditlookslikeI'mthequeen
//ThewindishowlinglikethisswirlingstorminsideCouldn'tkeepitin,heavenknowsI'vetriedDon'tletthemin,don'tletthemsee
//BethegoodgirlyoualwayshavetobeConceal,don'tfeel,don'tletthemknowWell,nowtheyknow
//Letitgo,letitgoCan'tholditbackanymorehttps://github.com/DoBest20/GBC_Project.gitLetitgo,letitgo
//TurnawayandslamthedoorIdon'tcarewhatthey'regoingtosayLetthestormrageonThecoldneverbotheredmeanyway
//It'sfunnyhowsomedistancemakeseverythingseemsmallAndthefearsthatoncecontrolledmecan'tgettomeatall
//It'stimetoseewhatIcandoTotestthelimitsandbreakthroughNoright,nowrong,norulesformeI'mfree
//Letitgo,letitgoIamonewiththewindandskyLetitgo,letitgoYou'llneverseemecryHereIstandandhereIstayLetthestormrageon
//MypowerflurriesthroughtheairintothegroundMysoulisspiralinginfrozenfractalsallaroundAndonethoughtcrystallizeslikeanicyblast
//I'mnevergoingback,thepastisinthepastLetitgo,letitgoWhenI'llriselikethebreakofdawnLetitgo,letitgoThatperfectgirlisgone
//HereIstandinthelightofdayLetthestormrageonThecoldneverbotheredmeanyway
    int rand_offset = 0;
    if (random) {
        srand(time(NULL));
        rand_offset = rand();
