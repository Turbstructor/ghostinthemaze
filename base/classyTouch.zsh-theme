...
local current_user='%{$fg[red]%}|%{$reset_color%}$(whoami)% %{$fg[red]%}|%{$reset_color%}'

PROMPT="%(?,%{$fg[red]%}┌─╼${current_user}${current_dir}%{$reset_color%} ${git_branch}
%{$fg[red]%}└────╼%{$reset_color%} ,%{$fg[red]%}┌─╼${current_user}${current_dir}%{$reset_color%} ${git_branch}
%{$fg[red]%}└╼ %{$reset_color%} "
